...
! function(t) {
    ...
    i.resize = k(u, E), i.scroll = k(u, "scroll.webflow resize.webflow orientationchange.webflow load.webflow"), i.redraw = k(), i.location = function(t) {
        ...
        t = t || {}, p = !0, u.triggerHandler("__wf_destroy"), null != t.domready && (h = t.domready), f.each(r, m), i.resize.off(), i.scroll.off(), i.redraw.off(), o = [], a = [], "pending" === _.state() && L()
    ...
    window.tram = function(t) {
        ...
        var M = e.frame = function() {
            ...
            N = l(function(e) {
                ...
                e.init = function(e) {
                    ...
                    C.backface && B.hideBackface && Z(this.el, C.backface.css, "hidden")
            ...
            D = l(function(e) {
                function n() {
                    ...
                    if (r)
                        for (M(n), e = $(), t = r; t--;)(i = u[t]) && i.render(e)
                }
                var i = {
                    ease: f.ease[1],
                    from: 0,
                ...
                e.init = function(t) {
                    ...
                    var t;
                    this.active || (this.start || (this.start = $()), this.active = !0, t = this, 1 === u.push(t) && M(n))
                }, e.stop = function() {
                    var e, n, i;
        ...
        C.transform && (K.transform = [W], Y = {
            ...
            skewX: [_],
            skewY: [_]
        }), C.transform && C.backface && (Y.z = [x, "translateZ"], Y.rotateZ = [_], Y.scaleZ = [g], Y.perspective = [y]);
        var Q = /ms/,
            V = /s|\./;
        return t.tram = e
    }(window.jQuery)
    ...
    i.define("dropdown", t.exports = function(t, e) {
        ...
        function O() {
            n = f && i.env("design"), (u = L.find(p)).each(T)
        }
        ...
        function T(e, r) {
            ...
            l || (l = t.data(r, p, {
                ...
                e.mouseUpOutside && L.off(E, e.mouseUpOutside);
                return c(function(n) {
                    if (e.open) {
                        var r = t(n.target);
            ...
            n && l.el.on(A, function(t) {
                return function(e, n) {
                    n = n || {}, S(t), !0 === n.open && C(t), !1 === n.open && z(t, {
                        immediate: !0
                    })
                }
        ...
        function C(e) {
            if (!e.open) {
                ...
                var r = i.env("editor");
                n || L.on(E, e.mouseUpOutside), e.hovering && !r && e.el.on(_, e.mouseLeave), e.hovering && r && L.on(x, e.mouseMoveOutside), window.clearTimeout(e.delayId)
            }
        }
        ...
        function z(t) {
            ...
            if (t.open && (!t.config.hover || !t.hovering || i)) {
                ...
                var r = t.config;
                if (m.outro(0, t.el[0]), L.off(E, t.mouseUpOutside), L.off(x, t.mouseMoveOutside), t.el.off(_, t.mouseLeave), window.clearTimeout(t.delayId), !r.delay || n) return t.complete();
